#pragma checksum "C:\Users\msena\Desktop\Sistemas\MS_LojaVirtual\MS_LojaVirtual\MS_LojaVirtual\Views\Home\Contato.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a05fd9dedf4ff2abc996fbef651566a26839a5fd"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a05fd9dedf4ff2abc996fbef651566a26839a5fd", @"/Views/Home/Contato.cshtml")]
          ...
          <div class=""row"">
            ...
            WriteLiteral(@"                              <span class=""input-group-text""><i class=""fa fa-user""></i></span>
                                        ...
                                        <div class=""form-group"">
                                          ...
                                          ");
            WriteLiteral(@"        <input type=""text"" class=""form-control"" name=""cardNumber"" placeholder="""">
                                             </div> <!-- input-group.// -->
                                        </div> <!-- form-group.// -->
                                ...
                                ");
            WriteLiteral(@"        <button class=""subscribe btn btn-primary btn-block"" type=""button""> Enviar </button>
                                   </form>
                              </div> <!-- card-body.// -->
                         </article> <!-- card.// -->
